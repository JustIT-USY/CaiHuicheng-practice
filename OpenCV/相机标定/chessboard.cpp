...
int chessConers(string file, vector<vector<Point2f> > &imagePoints,Size &boardSize,Size &imageSize)
{
	...
	for (int i = 0; i < imageList.size(); i++)
	{
		...
		int corner_row = 9;//沿着行的内角点数//interior number of row corners.(this can be countered by fingers.)
		int corner_col = 6;//沿着列的内角点数//interior number of column corners.
